<footer id="footer" class="footer">
  ...
  <script src="{{ asset('tema/assets/vendor/quill/quill.min.js') }}"></script>
  <script src="{{ asset('tema/assets/vendor/simple-datatables/simple-datatables.js') }}assets/vendor/simple-datatables/simple-datatables.js"></script>
